...
ancient java web application, that could be dated ~2000 AD.
...
- has a working ```web.xml```` file. this file used to be the descriptor of the application,
and basically contain the deployment instructions for the servlet container.
